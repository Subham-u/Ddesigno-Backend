...
export const getProductsByCategory = asyncHandler(
    async (req,res)=> {
        ...
        return res.status(200).json( new ApiResponse(200,products,"Category Created Successfully") )
...
export const getProductById =  asyncHandler(
    async(req , res)=>{
        ...
        const product = await Product.findById(productId).populate('category', 'name') // Populate category name
        ...
        return res.status(200).json( new ApiResponse(200,product,"Category Created Successfully") )
    }
)